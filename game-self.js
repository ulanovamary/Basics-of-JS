...
const game = {
    ...
    start() {
        ...
        //console.log(answer);
        //this.textNodes.find((q) => q.id === 
        while (+answer !== -1) {
            let i = +answer - 1;
            nextId = this.textNodes.options[i].nextText;
            let nextQ = this.textNodes.find((q) => q.id === +nextId);
            //let nextQ = this.textNodes.options[+answer].nextText;    // options[(+answer) - 1].nextText);
            this.makeStep(nextQ);
        }
    },
